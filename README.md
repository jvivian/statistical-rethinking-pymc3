Taken from the [pymc3 devs **resources** directory](https://github.com/pymc-devs/resources). Updating as I go with practice problems for each chapter at the end of each notebook. 
